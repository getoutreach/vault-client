...
replace (
	// Vault depends on an old version of client Golang. Once it's dependencies have been updated, these
	// replacements can be removed: https://github.com/hashicorp/vault/issues/26792
